...
public class GridviewAdapter extends BaseAdapter {
    ...
    ArrayList<Productclass> bean;
    Typeface fonts1, fonts2;


    public GridviewAdapter(Context context,ArrayList<Productclass> bean) {
        this.bean = bean;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Productclass bean = (Productclass) getItem(position);
...
//
//    Context context;
//    ArrayList<Productclass> beans;
//
//    public GridviewAdapter(Context context,ArrayList<Productclass> beans) {
//        this.beans = beans;
//        this.context = context;
//    }
//
...
//
//
//        Productclass beans = (Productclass)getItem(position);
//
