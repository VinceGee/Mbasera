...
public class CartFragment extends Fragment {
    ...
    public void messageDialog(String message, final Context activity) {
        ...
        FrameLayout paypal = (FrameLayout) myDialog.findViewById(R.id.paypal);
        ...
        FrameLayout visa = (FrameLayout) myDialog.findViewById(R.id.visa);
        visa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(), "Still Processing VISA ", Toast.LENGTH_LONG).show();

                myDialog.dismiss();
            }
        });

        FrameLayout paynow = (FrameLayout) myDialog.findViewById(R.id.paynow);
        paynow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(), "Still Processing PAYNOW", Toast.LENGTH_LONG).show();

                myDialog.dismiss();
            }
        });

        FrameLayout ecocash = (FrameLayout) myDialog.findViewById(R.id.ecocash);
        ecocash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(), "Still Processing ECOCASH", Toast.LENGTH_LONG).show();
